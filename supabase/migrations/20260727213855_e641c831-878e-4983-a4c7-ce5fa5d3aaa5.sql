...
GRANT SELECT, INSERT, UPDATE, DELETE ON public.venue_stakeholders TO service_role;
GRANT SELECT, INSERT, UPDATE, DELETE ON public.venue_booking_units TO service_role;
GRANT SELECT, INSERT, UPDATE, DELETE ON public.venue_space_booking_units TO service_role;
GRANT SELECT, INSERT, UPDATE, DELETE ON public.venue_counterpart_agreements TO service_role;
GRANT SELECT, INSERT, UPDATE, DELETE ON public.venue_events TO service_role;
GRANT SELECT, INSERT, UPDATE, DELETE ON public.venue_event_spaces TO service_role;
GRANT SELECT, INSERT, UPDATE, DELETE ON public.venue_space_blocks TO service_role;
GRANT SELECT, INSERT, UPDATE, DELETE ON public.venue_counterpart_usage TO service_role;
GRANT SELECT, INSERT, UPDATE, DELETE ON public.venue_counterpart_ledger TO service_role;
GRANT SELECT, INSERT, UPDATE, DELETE ON public.venue_occupancies TO service_role;
GRANT SELECT, INSERT, UPDATE, DELETE ON public.venue_event_responsibles TO service_role;
GRANT SELECT, INSERT, UPDATE, DELETE ON public.venue_event_resources TO service_role;
GRANT SELECT, INSERT, UPDATE, DELETE ON public.venue_checklist_templates TO service_role;
GRANT SELECT, INSERT, UPDATE, DELETE ON public.venue_event_checklist_items TO service_role;
GRANT SELECT, INSERT, UPDATE, DELETE ON public.venue_event_documents TO service_role;
GRANT SELECT, INSERT, UPDATE, DELETE ON public.venue_event_approvals TO service_role;
GRANT ALL ON public.venue_mutation_receipts TO service_role;
...
BEGIN
  INSERT INTO public.venue_spaces (
    org_id, slug, name, type, description, capacity, location,
    available_areas, restrictions, allowed_event_types,
    required_setup_minutes, required_teardown_minutes,
    default_responsible_team, available_resources, created_by, updated_by
  ) VALUES (
    _org_id, 'restaurante-fenasoja', 'Restaurante Fenasoja', 'restaurante',
    'Espaço gastronômico e institucional da Fenasoja.', 600,
  ...
  INSERT INTO public.venue_spaces (
    ...
    _org_id, 'arena-fenasoja', 'Arena Fenasoja', 'arena',
    'Arena multiuso para apresentações, shows e encontros de grande público.', 5000,
    'Parque de Exposições Alfredo Leandro Carlson',
  ...
  INSERT INTO public.venue_checklist_templates (
    org_id, space_id, event_type, title, deadline_offset_hours, phase, required, sort_order, created_by, updated_by
  ) VALUES
...
SELECT public.venue_seed_org_defaults(id) FROM public.organizations;

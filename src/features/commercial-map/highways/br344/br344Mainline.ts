...
/**
 * Crossing X of the future NE cloverleaf. Matches the current BR-472 spine
 * (`br472Junction` x=6120) so Agent #1 can extend that highway due north
 * and Agent #3 can hang ramps on a shared vertex. Not a ramp.
 */
export const BR344_BR472_CROSSING_SOURCE_X = 6120;
...
export const BR344_NE_CLOVERLEAF_HANDOFF = Object.freeze({
  ...
  notes: 'Agent #3 attaches NE cloverleaf ramps here. Agent #1 extends BR-472 north to this Y. This slice has no ramps.',
});

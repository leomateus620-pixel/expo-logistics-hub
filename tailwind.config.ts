  ...
  theme: {
    ...
    extend: {
      ...
      keyframes: {
        ...
        "card-enter-3d": {
          "0%": { opacity: "0", transform: "translateY(12px) rotateX(-2deg) scale(0.985)" },
        ...
        "recipient-rise": {
          "0%":   { opacity: "0", transform: "translateY(16px) rotateX(-3deg) scale(0.985)" },
          "60%":  { opacity: "1", transform: "translateY(-2px) rotateX(0) scale(1.005)" },
          "100%": { opacity: "1", transform: "translateY(0) rotateX(0) scale(1)" },
        },
        "gold-shimmer": {
      ...
      animation: {
        ...
        "shimmer": "none",
        "float": "none",
        "card-enter-3d": "card-enter-3d var(--motion-structural) var(--ease-decelerate) both",
        ...
        "cart-shimmer": "none",
        "halo-breath": "none",
        "recipient-rise": "recipient-rise var(--motion-structural) var(--ease-spring) both",
        "gold-shimmer": "none",
        "floating-bar-in": "floating-bar-in var(--motion-base) var(--ease-decelerate) both",
      },
    },
  },

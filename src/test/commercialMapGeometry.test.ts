...
describe('regras comerciais e segurança', () => {
  ...
  it('importa somente os lotes e módulos numerados pela planta e os mantém comercialmente bloqueados', () => {
    ...
    expect(pavilionModules).toHaveLength(927);

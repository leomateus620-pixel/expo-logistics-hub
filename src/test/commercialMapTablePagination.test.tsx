...
const permissions = { canView: true, canEdit: false, canEditGeometry: false, canManageLots: false, canEditPricing: false, canManageSales: false, canManageContracts: false, canManageLayers: false, canViewMapAnalytics: false, isMapAdmin: false };
function Harness() {

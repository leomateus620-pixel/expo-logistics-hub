...
describe('projeção oficial do Pavilhão 1', () => {
  ...
  it('mantém os demais pavilhões no frame identity/stretch', () => {
    ['B2', 'B3', 'B6', 'B8'].forEach((identifier) => {
      const plan = COMMERCIAL_PAVILION_MODULE_PLANS[identifier as 'B2' | 'B3' | 'B6' | 'B8'];

...
it('abre detalhes de estande sem voar uma câmera inexistente no fallback', () => {
  ...
  function Harness() {
    ...
    return <MapListView explorer={explorer} sceneAvailable={false} canRetry3D={false}
      permissions={{ canView: true, canEdit: false, canEditGeometry: false, canManageLots: false, canEditPricing: false, canManageSales: false, canManageContracts: false, canManageLayers: false, canViewMapAnalytics: false, isMapAdmin: false }} />;
  }
  render(<Harness />);

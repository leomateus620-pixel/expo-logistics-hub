...
function Diagnostic() {
  ...
  return <main data-qa-host={host} style={style}>{done ? <p>Official Countdown</p> : <><AlvoradaIntro onFinished={() => setDone(true)} /><button style={{ position: 'absolute', right: 12, bottom: 12, zIndex: 20 }} onClick={() => setDone(true)}>Pular animação</button></>}</main>;
}

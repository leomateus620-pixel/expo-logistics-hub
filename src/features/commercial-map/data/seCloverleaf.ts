 ...
 *
 * Handoff para a fita N–S existente: `SE_CLOVERLEAF_JOIN_SOURCE`. Não estender
 * `br472SouthRampToSouth` através deste trevo.
 */
export const SE_CLOVERLEAF_REVISION = '2026.9-se-cloverleaf.1';

export type SeCloverleafPoint = readonly [number, number];

/** Término sul atual da BR-472 gerada (`br472SouthRampToSouth`). */
export const SE_CLOVERLEAF_JOIN_SOURCE = Object.freeze([6146, 4400] as const);

/**
 * Centro do cloverleaf: mesma abscissa da BR-472, a sudeste do hub e a sul
 * do Portão 5. Mais próximo do parque do que o trevo nordeste BR-344×472.
 */
export const SE_CLOVERLEAF_CENTER_SOURCE = Object.freeze([6146, 4987] as const);

export const SE_CLOVERLEAF_JOIN_LOCAL = Object.freeze(
  officialPdfPointToLocal(SE_CLOVERLEAF_JOIN_SOURCE),
);
export const SE_CLOVERLEAF_CENTER_LOCAL = Object.freeze(
  officialPdfPointToLocal(SE_CLOVERLEAF_CENTER_SOURCE),
);

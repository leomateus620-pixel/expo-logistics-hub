-- Exporural 2026.3 targeted geometry rollout
-- This migration installs an explicit map.admin RPC. It never runs a bulk
-- update on deployment. Existing commercial state is preserved; only a
-- demonstrably inert legacy Semear seed may be archived with history/lineage.

...
export const FENASOJA_COMPLEX = {
  ...
  headquarters: {
    ...
    footprint: [
      [-4.5,-4.85],[.7,-4.85],[.7,-2.35],[1.025,-2.35],
      [1.025,-6.525],[4.475,-6.525],[4.475,-3.2],[6.275,-3.2],
      [6.275,-.3],[3.25,-.3],[3.25,4.55],[-2.53,4.55],
      [-2.53,6.775],[-4.24,6.775],[-4.24,7.6],[-4.42,7.6],
      [-4.42,6.775],[-4.43,6.775],[-4.43,4.325],[-3.25,4.325],
      [-3.25,-1.55],[-4.5,-1.55],
    ] as Point[],
